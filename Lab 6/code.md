...
5397933058015226858730761997532436477485554607150438968449403661304976\
...
(*Step 2:Generate ElGamal Keys*)
privateKey = RandomInteger[{1, p - 2}];
publicKey = PowerMod[g, privateKey, p];

(*Step 3:Sign the Message*)
(*Using predetermined values for r and s for demonstration*)
r = RandomInteger[{1, p - 1}];
s = RandomInteger[{1, p - 2}];

(*Step 4:Validate the Signature*)
(*Simplified validation for demonstration*)
isValidSignature =
  Mod[PowerMod[publicKey, r, p]*PowerMod[r, s, p], p] ==
   PowerMod[g, hashedMessage, p];
